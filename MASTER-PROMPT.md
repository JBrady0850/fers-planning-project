...
4. **Military service.** Every period of active duty, the dates, and whether a military service deposit has been paid, is in progress, or has never been started. Ask whether the user is receiving or will receive military retired pay.
...
- **The military deposit deadline.** The deposit must be paid before separation from federal service. OPM cannot accept it after retirement. The amount is generally 3 percent of military basic pay plus interest, with variations for 1999 and 2000 service. Price the deposit against the annuity increase it buys and show the payback period in years.
...
**Sick leave credit.** Unused sick leave is added to creditable service **for the annuity computation only**. It does not count toward retirement eligibility, it does not raise the high-3, and it does not help reach the 20 years needed for the 1.1 percent multiplier. Since January 1, 2014 FERS retirees receive 100 percent credit. Convert at 2,087 hours per year and 8 hours per day, and note that residual days beyond whole months are dropped. Express the result as additional annual annuity dollars, because that is the number that makes the balance feel like money.
...
1. List every account the user spends from: checking, savings, every credit card, and any aggregator such as Empower or Monarch. Confirm each one will be exported.
